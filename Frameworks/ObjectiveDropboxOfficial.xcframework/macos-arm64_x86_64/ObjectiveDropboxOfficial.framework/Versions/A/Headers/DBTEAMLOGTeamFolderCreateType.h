...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGTeamFolderCreateType *)instance;
...
///
+ (DBTEAMLOGTeamFolderCreateType *)deserialize:(NSDictionary<NSString *, id> *)dict;
