...
/// objects.
///
@interface DBTEAMLOGSfFbInviteChangeRoleType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGSfFbInviteChangeRoleType` instances.
///
/// @param instance An instance of the `DBTEAMLOGSfFbInviteChangeRoleType` API
/// object.
///
