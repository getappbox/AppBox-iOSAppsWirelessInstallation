...
/// objects.
///
@interface DBTEAMLOGBackupStatus : NSObject <DBSerializable, NSCopying>
...
@property (nonatomic, readonly) DBTEAMLOGBackupStatusTag tag;
...
///
/// The serialization class for the `DBTEAMLOGBackupStatus` union.
///
@interface DBTEAMLOGBackupStatusSerializer : NSObject

///
/// Serializes `DBTEAMLOGBackupStatus` instances.
///
/// @param instance An instance of the `DBTEAMLOGBackupStatus` API object.
///
/// @return A json-compatible dictionary representation of the
/// `DBTEAMLOGBackupStatus` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGBackupStatus *)instance;

///
/// Deserializes `DBTEAMLOGBackupStatus` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMLOGBackupStatus` API object.
///
/// @return An instantiation of the `DBTEAMLOGBackupStatus` object.
///
+ (DBTEAMLOGBackupStatus *)deserialize:(NSDictionary<NSString *, id> *)dict;
