...
/// objects.
///
@interface DBTEAMLOGPaperDocRevertType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `PaperDocRevertType` struct.
///
@interface DBTEAMLOGPaperDocRevertTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGPaperDocRevertType` instances.
///
/// @param instance An instance of the `DBTEAMLOGPaperDocRevertType` API object.
///
