...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBFILESListFolderContinueArg *)instance;
...
///
+ (DBFILESListFolderContinueArg *)deserialize:(NSDictionary<NSString *, id> *)dict;
