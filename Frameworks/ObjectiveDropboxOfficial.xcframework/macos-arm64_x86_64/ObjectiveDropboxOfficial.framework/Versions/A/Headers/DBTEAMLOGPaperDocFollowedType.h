...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGPaperDocFollowedType *)instance;
...
///
+ (DBTEAMLOGPaperDocFollowedType *)deserialize:(NSDictionary<NSString *, id> *)dict;
