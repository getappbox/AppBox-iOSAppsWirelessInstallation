...
///
/// The serialization class for the `FileAddType` struct.
///
@interface DBTEAMLOGFileAddTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGFileAddType` instances.
///
/// @param instance An instance of the `DBTEAMLOGFileAddType` API object.
///
