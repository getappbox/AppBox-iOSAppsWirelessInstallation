...
/// objects.
///
@interface DBTEAMLOGMemberSpaceLimitsChangeCapsTypePolicyType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `MemberSpaceLimitsChangeCapsTypePolicyType`
/// struct.
///
@interface DBTEAMLOGMemberSpaceLimitsChangeCapsTypePolicyTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGMemberSpaceLimitsChangeCapsTypePolicyType` instances.
///
