...
@class DBTEAMPOLICIESPasswordControlMode;
...
/// objects.
///
@interface DBTEAMPOLICIESPasswordControlMode : NSObject <DBSerializable, NSCopying>
...
@property (nonatomic, readonly) DBTEAMPOLICIESPasswordControlModeTag tag;
...
///
/// Description of the "disabled" tag state: Password is disabled.
///
...
///
/// Description of the "enabled" tag state: Password is enabled.
///
/// @return An initialized instance.
///
...
///
/// Serializes `DBTEAMPOLICIESPasswordControlMode` instances.
///
/// @param instance An instance of the `DBTEAMPOLICIESPasswordControlMode` API
/// object.
///
/// @return A json-compatible dictionary representation of the
/// `DBTEAMPOLICIESPasswordControlMode` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMPOLICIESPasswordControlMode *)instance;

///
/// Deserializes `DBTEAMPOLICIESPasswordControlMode` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMPOLICIESPasswordControlMode` API object.
///
/// @return An instantiation of the `DBTEAMPOLICIESPasswordControlMode` object.
///
+ (DBTEAMPOLICIESPasswordControlMode *)deserialize:(NSDictionary<NSString *, id> *)dict;
