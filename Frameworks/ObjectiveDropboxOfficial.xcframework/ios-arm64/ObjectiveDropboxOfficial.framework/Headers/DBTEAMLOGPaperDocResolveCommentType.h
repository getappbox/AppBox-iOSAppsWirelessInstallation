...
/// objects.
///
@interface DBTEAMLOGPaperDocResolveCommentType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGPaperDocResolveCommentType` instances.
///
/// @param instance An instance of the `DBTEAMLOGPaperDocResolveCommentType` API
/// object.
///
