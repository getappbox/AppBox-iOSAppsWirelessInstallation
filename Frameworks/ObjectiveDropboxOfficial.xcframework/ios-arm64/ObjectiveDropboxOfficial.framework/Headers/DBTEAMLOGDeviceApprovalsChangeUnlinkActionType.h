...
/// objects.
///
@interface DBTEAMLOGDeviceApprovalsChangeUnlinkActionType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `DeviceApprovalsChangeUnlinkActionType`
/// struct.
///
@interface DBTEAMLOGDeviceApprovalsChangeUnlinkActionTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGDeviceApprovalsChangeUnlinkActionType` instances.
///
