...
typedef NS_CLOSED_ENUM(NSInteger, DBTEAMMembersAddLaunchTag) {
...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMMembersAddLaunch *)instance;
...
///
+ (DBTEAMMembersAddLaunch *)deserialize:(NSDictionary<NSString *, id> *)dict;
