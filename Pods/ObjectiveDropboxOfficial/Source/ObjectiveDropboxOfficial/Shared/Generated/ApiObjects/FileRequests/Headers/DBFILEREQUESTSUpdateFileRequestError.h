...
///
/// The `UpdateFileRequestError` union.
///
...
/// objects.
///
@interface DBFILEREQUESTSUpdateFileRequestError : NSObject <DBSerializable, NSCopying>
...
@property (nonatomic, readonly) DBFILEREQUESTSUpdateFileRequestErrorTag tag;
...
///
/// The serialization class for the `DBFILEREQUESTSUpdateFileRequestError`
/// union.
///
@interface DBFILEREQUESTSUpdateFileRequestErrorSerializer : NSObject

///
/// Serializes `DBFILEREQUESTSUpdateFileRequestError` instances.
///
/// @param instance An instance of the `DBFILEREQUESTSUpdateFileRequestError`
/// API object.
///
