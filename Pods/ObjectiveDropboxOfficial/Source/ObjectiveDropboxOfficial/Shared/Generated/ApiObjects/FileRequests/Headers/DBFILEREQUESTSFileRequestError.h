...
@class DBFILEREQUESTSFileRequestError;
...
@property (nonatomic, readonly) DBFILEREQUESTSFileRequestErrorTag tag;
...
///
/// The serialization class for the `DBFILEREQUESTSFileRequestError` union.
///
@interface DBFILEREQUESTSFileRequestErrorSerializer : NSObject

///
/// Serializes `DBFILEREQUESTSFileRequestError` instances.
///
/// @param instance An instance of the `DBFILEREQUESTSFileRequestError` API
/// object.
///
/// @return A json-compatible dictionary representation of the
/// `DBFILEREQUESTSFileRequestError` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBFILEREQUESTSFileRequestError *)instance;

///
/// Deserializes `DBFILEREQUESTSFileRequestError` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBFILEREQUESTSFileRequestError` API object.
///
/// @return An instantiation of the `DBFILEREQUESTSFileRequestError` object.
///
+ (DBFILEREQUESTSFileRequestError *)deserialize:(NSDictionary<NSString *, id> *)dict;
