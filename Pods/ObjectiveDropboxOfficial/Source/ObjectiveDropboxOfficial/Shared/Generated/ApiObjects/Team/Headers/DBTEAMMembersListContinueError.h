...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMMembersListContinueError *)instance;
...
///
+ (DBTEAMMembersListContinueError *)deserialize:(NSDictionary<NSString *, id> *)dict;
