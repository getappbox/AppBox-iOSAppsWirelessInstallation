...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGFileDownloadDetails *)instance;
...
///
+ (DBTEAMLOGFileDownloadDetails *)deserialize:(NSDictionary<NSString *, id> *)dict;
