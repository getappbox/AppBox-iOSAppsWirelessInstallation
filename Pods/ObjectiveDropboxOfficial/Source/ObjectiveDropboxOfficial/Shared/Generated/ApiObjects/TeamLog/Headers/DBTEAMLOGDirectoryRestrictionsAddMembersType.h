...
/// objects.
///
@interface DBTEAMLOGDirectoryRestrictionsAddMembersType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `DirectoryRestrictionsAddMembersType`
/// struct.
///
@interface DBTEAMLOGDirectoryRestrictionsAddMembersTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGDirectoryRestrictionsAddMembersType` instances.
///
