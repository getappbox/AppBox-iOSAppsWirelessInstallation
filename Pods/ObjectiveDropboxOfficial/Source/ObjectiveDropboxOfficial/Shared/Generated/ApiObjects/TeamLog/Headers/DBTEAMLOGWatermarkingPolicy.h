...
/// objects.
///
@interface DBTEAMLOGWatermarkingPolicy : NSObject <DBSerializable, NSCopying>
...
@property (nonatomic, readonly) DBTEAMLOGWatermarkingPolicyTag tag;
...
///
/// Serializes `DBTEAMLOGWatermarkingPolicy` instances.
///
/// @param instance An instance of the `DBTEAMLOGWatermarkingPolicy` API object.
///
/// @return A json-compatible dictionary representation of the
/// `DBTEAMLOGWatermarkingPolicy` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGWatermarkingPolicy *)instance;

///
/// Deserializes `DBTEAMLOGWatermarkingPolicy` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMLOGWatermarkingPolicy` API object.
///
/// @return An instantiation of the `DBTEAMLOGWatermarkingPolicy` object.
///
+ (DBTEAMLOGWatermarkingPolicy *)deserialize:(NSDictionary<NSString *, id> *)dict;
