...
/// `DBTEAMLOGMemberTransferAccountContentsType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGMemberTransferAccountContentsType *)instance;
...
/// object.
///
+ (DBTEAMLOGMemberTransferAccountContentsType *)deserialize:(NSDictionary *)dict;
