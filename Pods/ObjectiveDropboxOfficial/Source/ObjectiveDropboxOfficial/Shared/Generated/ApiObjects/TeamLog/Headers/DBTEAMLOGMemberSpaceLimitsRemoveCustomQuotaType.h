...
/// `DBTEAMLOGMemberSpaceLimitsRemoveCustomQuotaType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGMemberSpaceLimitsRemoveCustomQuotaType *)instance;
...
///
+ (DBTEAMLOGMemberSpaceLimitsRemoveCustomQuotaType *)deserialize:(NSDictionary *)dict;
