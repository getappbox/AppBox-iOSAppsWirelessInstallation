...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGOpenNoteSharedDetails *)instance;
...
///
+ (DBTEAMLOGOpenNoteSharedDetails *)deserialize:(NSDictionary<NSString *, id> *)dict;
