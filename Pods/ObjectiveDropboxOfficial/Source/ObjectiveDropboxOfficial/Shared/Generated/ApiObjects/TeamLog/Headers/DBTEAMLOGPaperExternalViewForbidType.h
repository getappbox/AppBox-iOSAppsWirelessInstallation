...
/// objects.
///
@interface DBTEAMLOGPaperExternalViewForbidType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `PaperExternalViewForbidType` struct.
///
@interface DBTEAMLOGPaperExternalViewForbidTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGPaperExternalViewForbidType` instances.
///
/// @param instance An instance of the `DBTEAMLOGPaperExternalViewForbidType`
/// API object.
///
