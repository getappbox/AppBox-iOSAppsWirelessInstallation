...
/// objects.
///
@interface DBTEAMLOGAccountCaptureNotificationEmailsSentType : NSObject <DBSerializable, NSCopying>
...
/// struct.
///
@interface DBTEAMLOGAccountCaptureNotificationEmailsSentTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGAccountCaptureNotificationEmailsSentType` instances.
///
