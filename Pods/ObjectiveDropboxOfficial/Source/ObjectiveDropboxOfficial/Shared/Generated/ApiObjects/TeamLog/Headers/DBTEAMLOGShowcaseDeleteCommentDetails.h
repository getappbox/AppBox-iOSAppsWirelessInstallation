...
///
/// The `ShowcaseDeleteCommentDetails` struct.
///
...
/// objects.
///
@interface DBTEAMLOGShowcaseDeleteCommentDetails : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGShowcaseDeleteCommentDetails` instances.
///
/// @param instance An instance of the `DBTEAMLOGShowcaseDeleteCommentDetails`
/// API object.
///
