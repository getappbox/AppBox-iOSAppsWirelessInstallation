...
/// objects.
///
@interface DBTEAMLOGSfTeamJoinFromOobLinkType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `SfTeamJoinFromOobLinkType` struct.
///
@interface DBTEAMLOGSfTeamJoinFromOobLinkTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGSfTeamJoinFromOobLinkType` instances.
///
/// @param instance An instance of the `DBTEAMLOGSfTeamJoinFromOobLinkType` API
/// object.
///
