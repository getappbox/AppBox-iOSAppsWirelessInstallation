...
/// objects.
///
@interface DBTEAMLOGAccountCaptureChangePolicyType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGAccountCaptureChangePolicyType` instances.
///
/// @param instance An instance of the `DBTEAMLOGAccountCaptureChangePolicyType`
/// API object.
///
