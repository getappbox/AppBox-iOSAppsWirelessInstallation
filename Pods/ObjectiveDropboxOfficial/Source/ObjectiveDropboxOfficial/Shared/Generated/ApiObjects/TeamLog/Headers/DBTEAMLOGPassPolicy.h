...
/// objects.
///
@interface DBTEAMLOGPassPolicy : NSObject <DBSerializable, NSCopying>
...
typedef NS_ENUM(NSInteger, DBTEAMLOGPassPolicyTag) {
  /// (no description).
...
///
/// The serialization class for the `DBTEAMLOGPassPolicy` union.
///
@interface DBTEAMLOGPassPolicySerializer : NSObject

///
/// Serializes `DBTEAMLOGPassPolicy` instances.
///
/// @param instance An instance of the `DBTEAMLOGPassPolicy` API object.
///
/// @return A json-compatible dictionary representation of the
/// `DBTEAMLOGPassPolicy` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGPassPolicy *)instance;

///
/// Deserializes `DBTEAMLOGPassPolicy` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMLOGPassPolicy` API object.
///
/// @return An instantiation of the `DBTEAMLOGPassPolicy` object.
///
+ (DBTEAMLOGPassPolicy *)deserialize:(NSDictionary<NSString *, id> *)dict;
