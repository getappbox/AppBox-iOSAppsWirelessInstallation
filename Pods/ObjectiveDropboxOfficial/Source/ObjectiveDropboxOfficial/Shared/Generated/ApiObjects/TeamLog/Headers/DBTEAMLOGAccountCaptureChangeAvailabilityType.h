...
/// objects.
///
@interface DBTEAMLOGAccountCaptureChangeAvailabilityType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `AccountCaptureChangeAvailabilityType`
/// struct.
///
@interface DBTEAMLOGAccountCaptureChangeAvailabilityTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGAccountCaptureChangeAvailabilityType` instances.
///
