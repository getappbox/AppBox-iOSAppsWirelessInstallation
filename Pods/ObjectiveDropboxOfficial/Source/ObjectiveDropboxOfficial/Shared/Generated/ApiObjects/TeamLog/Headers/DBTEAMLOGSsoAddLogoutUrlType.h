...
/// objects.
///
@interface DBTEAMLOGSsoAddLogoutUrlType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGSsoAddLogoutUrlType` instances.
///
/// @param instance An instance of the `DBTEAMLOGSsoAddLogoutUrlType` API
/// object.
///
