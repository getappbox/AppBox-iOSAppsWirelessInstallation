...
/// objects.
///
@interface DBTEAMLOGSharedFolderChangeMembersPolicyType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `SharedFolderChangeMembersPolicyType`
/// struct.
///
@interface DBTEAMLOGSharedFolderChangeMembersPolicyTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGSharedFolderChangeMembersPolicyType` instances.
///
