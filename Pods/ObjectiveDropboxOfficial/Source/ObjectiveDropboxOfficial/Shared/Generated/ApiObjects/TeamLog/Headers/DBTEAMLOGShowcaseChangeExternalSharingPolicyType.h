...
/// objects.
///
@interface DBTEAMLOGShowcaseChangeExternalSharingPolicyType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGShowcaseChangeExternalSharingPolicyType` instances.
///
