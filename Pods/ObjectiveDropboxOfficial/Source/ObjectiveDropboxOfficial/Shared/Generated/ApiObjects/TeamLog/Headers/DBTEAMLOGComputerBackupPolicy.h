...
///
/// The `ComputerBackupPolicy` union.
///
...
/// objects.
///
@interface DBTEAMLOGComputerBackupPolicy : NSObject <DBSerializable, NSCopying>
...
@property (nonatomic, readonly) DBTEAMLOGComputerBackupPolicyTag tag;
...
///
/// The serialization class for the `DBTEAMLOGComputerBackupPolicy` union.
///
@interface DBTEAMLOGComputerBackupPolicySerializer : NSObject

///
/// Serializes `DBTEAMLOGComputerBackupPolicy` instances.
///
/// @param instance An instance of the `DBTEAMLOGComputerBackupPolicy` API
/// object.
///
/// @return A json-compatible dictionary representation of the
/// `DBTEAMLOGComputerBackupPolicy` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGComputerBackupPolicy *)instance;

///
/// Deserializes `DBTEAMLOGComputerBackupPolicy` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMLOGComputerBackupPolicy` API object.
///
/// @return An instantiation of the `DBTEAMLOGComputerBackupPolicy` object.
///
+ (DBTEAMLOGComputerBackupPolicy *)deserialize:(NSDictionary<NSString *, id> *)dict;
