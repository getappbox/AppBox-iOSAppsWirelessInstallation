...
/// `DBTEAMLOGDirectoryRestrictionsAddMembersDetails` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGDirectoryRestrictionsAddMembersDetails *)instance;
...
///
+ (DBTEAMLOGDirectoryRestrictionsAddMembersDetails *)deserialize:(NSDictionary *)dict;
