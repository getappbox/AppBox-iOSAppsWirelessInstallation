...
/// objects.
///
@interface DBTEAMLOGSharedFolderUnmountType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGSharedFolderUnmountType` instances.
///
/// @param instance An instance of the `DBTEAMLOGSharedFolderUnmountType` API
/// object.
///
