...
/// `DBTEAMLOGSharedContentChangeLinkPasswordType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGSharedContentChangeLinkPasswordType *)instance;
...
///
+ (DBTEAMLOGSharedContentChangeLinkPasswordType *)deserialize:(NSDictionary *)dict;
