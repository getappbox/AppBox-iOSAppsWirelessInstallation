...
/// objects.
///
@interface DBTEAMLOGFileRequestsEmailsRestrictedToTeamOnlyType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `FileRequestsEmailsRestrictedToTeamOnlyType`
/// struct.
///
@interface DBTEAMLOGFileRequestsEmailsRestrictedToTeamOnlyTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGFileRequestsEmailsRestrictedToTeamOnlyType` instances.
///
