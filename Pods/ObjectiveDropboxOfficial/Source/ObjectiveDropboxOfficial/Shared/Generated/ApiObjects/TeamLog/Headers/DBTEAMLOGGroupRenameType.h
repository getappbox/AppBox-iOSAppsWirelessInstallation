...
/// objects.
///
@interface DBTEAMLOGGroupRenameType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `GroupRenameType` struct.
///
@interface DBTEAMLOGGroupRenameTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGGroupRenameType` instances.
///
/// @param instance An instance of the `DBTEAMLOGGroupRenameType` API object.
///
