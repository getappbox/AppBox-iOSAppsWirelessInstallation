...
/// `DBTEAMLOGAccountCaptureRelinquishAccountType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGAccountCaptureRelinquishAccountType *)instance;
...
///
+ (DBTEAMLOGAccountCaptureRelinquishAccountType *)deserialize:(NSDictionary *)dict;
