...
/// `DBTEAMLOGSharedContentRemoveLinkExpiryType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGSharedContentRemoveLinkExpiryType *)instance;
...
/// object.
///
+ (DBTEAMLOGSharedContentRemoveLinkExpiryType *)deserialize:(NSDictionary *)dict;
