...
/// `DBTEAMLOGDirectoryRestrictionsRemoveMembersType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGDirectoryRestrictionsRemoveMembersType *)instance;
...
///
+ (DBTEAMLOGDirectoryRestrictionsRemoveMembersType *)deserialize:(NSDictionary *)dict;
