...
/// `DBTEAMLOGTeamSelectiveSyncSettingsChangedType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGTeamSelectiveSyncSettingsChangedType *)instance;
...
///
+ (DBTEAMLOGTeamSelectiveSyncSettingsChangedType *)deserialize:(NSDictionary *)dict;
