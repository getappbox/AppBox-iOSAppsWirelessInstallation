...
/// objects.
///
@interface DBTEAMLOGFileTransfersPolicy : NSObject <DBSerializable, NSCopying>
...
@property (nonatomic, readonly) DBTEAMLOGFileTransfersPolicyTag tag;
...
///
/// The serialization class for the `DBTEAMLOGFileTransfersPolicy` union.
///
@interface DBTEAMLOGFileTransfersPolicySerializer : NSObject

///
/// Serializes `DBTEAMLOGFileTransfersPolicy` instances.
///
/// @param instance An instance of the `DBTEAMLOGFileTransfersPolicy` API
/// object.
///
/// @return A json-compatible dictionary representation of the
/// `DBTEAMLOGFileTransfersPolicy` API object.
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGFileTransfersPolicy *)instance;

///
/// Deserializes `DBTEAMLOGFileTransfersPolicy` instances.
///
/// @param dict A json-compatible dictionary representation of the
/// `DBTEAMLOGFileTransfersPolicy` API object.
///
/// @return An instantiation of the `DBTEAMLOGFileTransfersPolicy` object.
///
+ (DBTEAMLOGFileTransfersPolicy *)deserialize:(NSDictionary<NSString *, id> *)dict;
