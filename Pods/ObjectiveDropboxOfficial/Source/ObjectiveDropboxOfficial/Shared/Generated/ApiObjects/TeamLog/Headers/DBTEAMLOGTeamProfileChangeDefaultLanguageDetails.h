...
/// `DBTEAMLOGTeamProfileChangeDefaultLanguageDetails` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGTeamProfileChangeDefaultLanguageDetails *)instance;
...
///
+ (DBTEAMLOGTeamProfileChangeDefaultLanguageDetails *)deserialize:(NSDictionary *)dict;
