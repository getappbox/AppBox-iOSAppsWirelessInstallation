...
/// objects.
///
@interface DBTEAMLOGNoteAclLinkType : NSObject <DBSerializable, NSCopying>
...
///
/// Serializes `DBTEAMLOGNoteAclLinkType` instances.
///
/// @param instance An instance of the `DBTEAMLOGNoteAclLinkType` API object.
///
