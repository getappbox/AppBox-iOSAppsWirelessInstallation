...
/// `DBTEAMLOGPaperFolderChangeSubscriptionType` API object.
///
+ (nullable NSDictionary *)serialize:(DBTEAMLOGPaperFolderChangeSubscriptionType *)instance;
...
/// object.
///
+ (DBTEAMLOGPaperFolderChangeSubscriptionType *)deserialize:(NSDictionary *)dict;
