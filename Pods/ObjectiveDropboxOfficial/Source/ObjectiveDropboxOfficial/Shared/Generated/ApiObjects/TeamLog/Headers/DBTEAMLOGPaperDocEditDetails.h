...
///
+ (nullable NSDictionary<NSString *, id> *)serialize:(DBTEAMLOGPaperDocEditDetails *)instance;
...
///
+ (DBTEAMLOGPaperDocEditDetails *)deserialize:(NSDictionary<NSString *, id> *)dict;
