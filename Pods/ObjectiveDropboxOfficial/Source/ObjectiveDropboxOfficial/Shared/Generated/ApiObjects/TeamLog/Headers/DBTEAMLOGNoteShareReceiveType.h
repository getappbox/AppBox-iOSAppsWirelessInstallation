...
/// objects.
///
@interface DBTEAMLOGNoteShareReceiveType : NSObject <DBSerializable, NSCopying>
...
///
/// The serialization class for the `NoteShareReceiveType` struct.
///
@interface DBTEAMLOGNoteShareReceiveTypeSerializer : NSObject

///
/// Serializes `DBTEAMLOGNoteShareReceiveType` instances.
///
/// @param instance An instance of the `DBTEAMLOGNoteShareReceiveType` API
/// object.
///
