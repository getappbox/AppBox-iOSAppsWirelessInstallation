...
/// objects.
///
@interface DBFILESListFolderError : NSObject <DBSerializable>
...
///
+ (NSDictionary * _Nonnull)serialize:(DBFILESListFolderError * _Nonnull)instance;
...
///
+ (DBFILESListFolderError * _Nonnull)deserialize:(NSDictionary * _Nonnull)dict;
