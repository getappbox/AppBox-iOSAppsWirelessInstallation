...
/// objects.
///
@interface DBFILESListFolderContinueError : NSObject <DBSerializable>
...
///
+ (NSDictionary * _Nonnull)serialize:(DBFILESListFolderContinueError * _Nonnull)instance;
...
///
+ (DBFILESListFolderContinueError * _Nonnull)deserialize:(NSDictionary * _Nonnull)dict;
