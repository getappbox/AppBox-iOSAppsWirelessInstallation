...
/// objects.
///
@interface DBFILESDownloadError : NSObject <DBSerializable>
...
///
+ (NSDictionary * _Nonnull)serialize:(DBFILESDownloadError * _Nonnull)instance;
...
///
+ (DBFILESDownloadError * _Nonnull)deserialize:(NSDictionary * _Nonnull)dict;
