## How to contribute to AppBox

#### Did you find a bug?

* **Do not open up a GitHub issue if the bug is a security vulnerability in AppBox**, and instead to refer to [developer](mailto:publisher@developerinsider.co) directly
